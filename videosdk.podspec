Pod::Spec.new do |spec|
  ...
  spec.source_files = 'TXLiteAVSDK_Smart_iOS/SDK/TXLiteAVSDK.framework/Headers/*.h'
  #spec.source_files = 'frameworks/GPUImage.framework/Headers/*.h'
  spec.vendored_frameworks = 'TXLiteAVSDK_Smart_iOS/SDK/TXLiteAVSDK_Smart.framework'
